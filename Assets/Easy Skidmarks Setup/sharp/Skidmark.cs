...
public class Skidmark : MonoBehaviour
{
    ...
    private int maxMarks = 50; // Maximum number of marks total handled by one instance of the script.

    private float markWidth = 0.275f;
    ...
    private float minDistance = 0.1f; // The minimum distance between two marks places next to each other. 
